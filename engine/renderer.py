...
class CubeMapRenderer:
    def __init__(self):
        ...
        self._load_current_cubemap()

        self.clock = pygame.time.Clock()
        self.is_running = True

    def _load_current_cubemap(self):
        folder = self.cubemap_sets[self.current_cubemap_index]
        print(f"Ładowanie skybox: {folder}")
    ...
    def _render_frame(self):
        ...
        objects.draw_skybox_alternative(self.cube_map_id, self.camera.position)
